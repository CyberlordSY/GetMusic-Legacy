<?php
	class Account {
		...
		private function insertUserDetails($username, $firstName, $lastName, $email, $password) {
			...
			$result = mysqli_query($this->con, "INSERT INTO users (username, firstname, lastname, email, password, signup_date, profile_pic,admin) VALUES ('$username', '$firstName', '$lastName', '$email', '$encryptedPassword', '$date', '$profilePic','0')");
